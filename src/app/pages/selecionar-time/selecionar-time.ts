...
// Repetido aqui (em vez de importado) para evitar import circular entre selecionar-time.ts <-> jogadores.ts.
...
@Component({
  ...
  templateUrl: './selecionar-time.html',
  styleUrl: './selecionar-time.css'
})
export class SelecionarTimeComponent {
  times: Time[] = [
