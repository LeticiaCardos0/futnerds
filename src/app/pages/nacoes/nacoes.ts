...
@Component({
  ...
  // filtros e painel em arquivos à parte por causa do budget anyComponentStyle (avaliado por arquivo)
  styleUrls: ['./nacoes.css', './nacoes-filtros.css', './nacoes-painel.css'],
